          ...
          "<svg\n" +
            ...
            if (backColor != Color.White)
            {
                style = string.Format("style=\"fill:#{0}{1}{2};fill-opacity:{3};stroke:none\" ",
                              backColor.R.ToString("X2"), backColor.G.ToString("X2"), backColor.B.ToString("X2"), (backColor.A / (double)byte.MaxValue).ToString("0.##", _dotFormatProvider));
            ...
            for (int row = 0; row < enc.Region.SymbolRows; row++)
            {
                ...
                for (int col = 0; col < enc.Region.SymbolCols; col++)
                {
                    ...
                    style = string.Format("style=\"fill:#{0}{1}{2};fill-opacity:{3};stroke:none\" ",
                          foreColor.R.ToString("X2"), foreColor.G.ToString("X2"), foreColor.B.ToString("X2"), (foreColor.A / (double)byte.MaxValue).ToString("0.##", _dotFormatProvider));
